...
def czml_generator_MIGHTIA(filename):
    mightiadata = Dataset(filename, "r")

    time = mightiadata.variables["ICON_ANCILLARY_MIGHTI_TIME_UTC_STRING"]
    #determine orientation of spacecraft
    instra_x_hat = mightiadata.variables["ICON_ANCILLARY_MIGHTI_INSTRA_X_ECEF"]
    instra_y_hat = mightiadata.variables["ICON_ANCILLARY_MIGHTI_INSTRA_Y_ECEF"]
    instra_z_hat = mightiadata.variables["ICON_ANCILLARY_MIGHTI_INSTRA_Z_ECEF"]
    #determine position of spacecraft
    lat = mightiadata.variables["ICON_ANCILLARY_MIGHTI_LATITUDE"]
    lon = mightiadata.variables["ICON_ANCILLARY_MIGHTI_LONGITUDE"]
    alt = mightiadata.variables["ICON_ANCILLARY_MIGHTI_ALTITUDE"]
